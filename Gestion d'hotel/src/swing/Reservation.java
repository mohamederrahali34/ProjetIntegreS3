...
public class Reservation extends JFrame {
	...
	public Reservation() {
		...
		button.setFont(new Font("Lucida Sans Typewriter", Font.PLAIN, 18));
		button.setBorder(null);
		button.setBackground(new Color(244, 244, 244));
		button.setBounds(39, 539, 125, 48);
		panel.add(button);
		
		Label label = new Label("");
		label.setBackground(new Color(169, 169, 169));
		label.setBounds(10, 534, 174, 2);
		panel.add(label);
		
		JLabel label_1 = new JLabel("errahali@gmail.com");
		label_1.setFont(new Font("Modern No. 20", Font.BOLD, 20));
		label_1.setBounds(55, 457, 164, 71);
		panel.add(label_1);
		
		
		Panel panel_2 = new Panel();
		panel_2.setFont(new Font("Dialog", Font.ITALIC, 15));
		panel_2.setBounds(216, 0, 870, 155);
		...
		dateChooser.setBounds(217, 118, 140, 26);
		...
		scrollPane.setBounds(220, 161, 874, 437);
